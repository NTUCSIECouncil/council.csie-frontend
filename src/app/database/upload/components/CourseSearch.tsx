...
const CourseSearch = ({
  ...
  return (
    <div className="relative flex flex-col gap-2">
      ...
      {selectedCourse ? (
        <div className="flex items-center justify-between px-4 h-12 border border-gray-600 rounded-lg bg-gray-700">
          <div>
          ...
          {!disabled && (
            <button
              ...
              className="p-2 hover:bg-gray-600 rounded-full transition text-gray-400 hover:text-white cursor-pointer"
              title="清除選擇"
            >
              <FaTimes />
            </button>
        ...
        <div className="relative">
          <div className="relative">
            <input
              ...
              className="w-full px-4 h-12 pr-12 border border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500 bg-gray-700 text-white placeholder:text-gray-400 disabled:opacity-50 disabled:cursor-not-allowed"
              value={searchText}
              onChange={e => {
            ...
            <div className="absolute z-10 w-full mt-1 bg-gray-700 border border-gray-600 rounded-lg shadow-lg max-h-60 overflow-y-auto">
              {courses.map((course: Course, index: number) => (
                <button
                  key={index}
                  type="button"
                  className="w-full px-4 py-3 text-left hover:bg-gray-600 border-b border-gray-600 last:border-b-0 transition cursor-pointer"
                  onClick={() => {
