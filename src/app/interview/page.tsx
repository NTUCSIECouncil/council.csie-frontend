              ...
              <div className="hidden md:block">
                <div className="flex flex-col items-center p-4">
                  ...
                  <div className="flex flex-col w-full">
                    ...
                    <p className="text-gray-400 text-sm text-center text-balance uppercase">
                      {teacher.lab}
                    </p>
                  </div>
                ...
                <div className="hidden">
                  <div className="flex items-center w-full">
                    ...
                    <span className="px-2 text-gray-500 italic text-xs">
                      tags
                    </span>
                    <div className="grow border-t border-gray-500"></div>
                  </div>
                      ...
                      >
                        <div>
                          <MenuButton className="inline-flex justify-center gap-x-1.5 bg-violet-500 hover:bg-violet-800 text-white px-4 py-1 rounded-2xl">
                            Interviews
                            <svg
                              className="ml-1 -mr-1 size-6 text-white"
                              viewBox="0 0 20 20"
                              fill="currentColor"
                              data-slot="icon"
                            >
                        ...
                        <MenuItems className="absolute w-full mt-2 z-10 rounded-2xl bg-black/70 shadow-lg transition-all duration-200 ease-out transform scale-95 opacity-0 data-[headlessui-state=open]:scale-100 data-[headlessui-state=open]:opacity-100">
                          <div>
                            {teacher.links?.map((link, linkIndex) => (
                              <MenuItem
                                key={linkIndex}
