...
const CollapsibleCourseInfo = ({ courseData, semester }: Props): React.JSX.Element => {
  ...
  return (
    <div className="w-full px-4 my-4">
      ...
      >
        {isExpanded ? <FaChevronDown className="text-white" /> : <FaChevronRight className="text-white" />}
