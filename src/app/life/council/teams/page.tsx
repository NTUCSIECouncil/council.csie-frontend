...
import lifeTeams from './life-council-teams.json' with { type: 'json' };
...
const Page = (): React.JSX.Element => {
  ...
  const [content, setContent] = useState<TeamItem | null>(
    teams[tabItems[0].alt],
  );
  ...
  return (
    <div>
      ...
      {content && (
        <>
          <LifeSubTopic content={content.name} comment={content.comment} />
          {content.description && (
